...
import com.weiyitech.zhaopinzh.business.QueryFairJob;
...
import com.weiyitech.zhaopinzh.presentation.adapter.FairJobsScreenSlidePagerAdapter;
 ...
 */
public class FairJobListFragment extends CommonFragment {
    public ViewPager jobPager;
    public FairJobsScreenSlidePagerAdapter jobPagerAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ActionBar.OnNavigationListener mOnNavigationListener = new ActionBar.OnNavigationListener() {
            ...
            public boolean onNavigationItemSelected(int position, long itemId) {
                ...
                jobPagerAdapter = new FairJobsScreenSlidePagerAdapter(getChildFragmentManager());
        ...
        int dropdownIndex = Common.getJobsDropDownPref(getActivity());
        orderBy = dropdownIndex + 1;
        SpinnerAdapter mSpinnerAdapter = ArrayAdapter.createFromResource(getActivity(), R.array.job_action_list,
                android.R.layout.simple_spinner_dropdown_item);
        ActionBar actionBar = ((JobsOfFairActivity) getActivity()).getSupportActionBar();
        ...
        searchTerm.fairId = ((JobsOfFairActivity) getActivity()).fairId;
        // queryTotal(searchTerm);
    ...
    public void getDataFromBusiness(int dataType, Object t, int... position) {
        ...
        if (dataType == Common.JOBTOTAL_TYPE) {
            ...
            if (QueryFairJob.JOBDETAILREQ.equals(t)) {
                bundle.putInt("position", position[0]);
            }
    ...
    public void queryTotal(SearchTerm searchTerm) {
        ...
        QueryFairJob queryJob = new QueryFairJob();
        ...
        public void handleMessage(Message msg) {
            ...
            if (dataType == Common.ADD_PAGE_INDEX_TYPE) {
                ...
                if (getActivity() != null && !((CommonActivity) getActivity()).destroyed) {
                    ...
                    ((FairJobsScreenSlidePageFragment) jobPagerAdapter.instantiateItem(jobPager, uipage)).updateListView(pager, runEmployers);
                ...
                if (getActivity() != null && !((CommonActivity) getActivity()).destroyed) {
                    jobPagerAdapter.startUpdate(jobPager);
                    ((FairJobsScreenSlidePageFragment) jobPagerAdapter.instantiateItem(jobPager, pageManageUtil.currentPage)).updateJobConciseView(jobConciseRsps, position);
                    jobPagerAdapter.finishUpdate(jobPager);
                }
            } else if (dataType == Common.TIMEOUT_TYPE) {
                int reqType = bundle.getInt("req");
                if (QueryFairJob.JOBDETAILREQ == reqType) {
                    timeoutDo(reqType, bundle.getInt("position"));
                } else if (QueryFairJob.EMPLOYERDETAILREQ == reqType) {
                    timeoutDo(reqType, bundle.getInt("position"));
                } else {
                    timeoutDo(reqType, -1);
                }
                ...
                if (getActivity() != null && !((CommonActivity) getActivity()).destroyed) {
                    jobPagerAdapter.startUpdate(jobPager);
                    ((FairJobsScreenSlidePageFragment) jobPagerAdapter.instantiateItem(jobPager, commentConcise.pageIndex)).updateCommentCnt(commentConcise.total, commentConcise.position);
                    jobPagerAdapter.finishUpdate(jobPager);
                }
            }
        }
    ...
    public void timeoutDo(int req, int position) {
        ...
        try {
            if (zhaopinzhApp.runEmployerRspTimeout && req == QueryFairJob.JOBCONCISEREQ) {
    ...
    public void onResume() {
            ...
            if (!resumeSearchTerm.searchConditionItemEqual(searchTerm)) {
                ...
                if (bundle != null) {
                    ...
                    if (cursor != null) {
                        ...
                        try {
                            //searchTerm.keyword = URLEncoder.encode(cursor.getString(iIndex), "utf-8");
        ...
        super.onResume();
        //MobclickAgent.onPageStart("FairJobListFragment"); //统计页面
