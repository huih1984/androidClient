...
import com.weiyitech.zhaopinzh.business.QueryUniversityPreaching;
import com.weiyitech.zhaopinzh.presentation.R;
import com.weiyitech.zhaopinzh.presentation.activity.UniversityCampusActivity;
import com.weiyitech.zhaopinzh.presentation.adapter.UniversityPreachListScreenSlidePagerAdapter;
 ...
 */
public class UniversityPreachingMeetListFragment extends Fragment implements BusinessInterface {
    public ViewPager preachMeetingPager;
    public UniversityPreachListScreenSlidePagerAdapter universityPreachListScreenSlidePagerAdapter;
    public static Context context = null;
    public int totalPreachConciseCnt = 0;

    public SearchTerm searchTerm;
    PageManageUtil pageManageUtil;
    int orderBy = 0;
        ...
        if (rootView == null) {
            ActionBar.OnNavigationListener mOnNavigationListener = new ActionBar.OnNavigationListener() {
                ...
                public boolean onNavigationItemSelected(int position, long itemId) {
                    ...
                    universityPreachListScreenSlidePagerAdapter = new UniversityPreachListScreenSlidePagerAdapter(getChildFragmentManager());
                    universityPreachListScreenSlidePagerAdapter.setContext(getActivity());
                    universityPreachListScreenSlidePagerAdapter.setViewPager(preachMeetingPager);
                    preachMeetingPager.setAdapter(universityPreachListScreenSlidePagerAdapter);
            ...
            SpinnerAdapter mSpinnerAdapter = ArrayAdapter.createFromResource(getActivity(), R.array.preach_action_list,
                    android.R.layout.simple_spinner_dropdown_item);
            ActionBar actionBar = ((UniversityCampusActivity) getActivity()).getSupportActionBar();
            actionBar.setNavigationMode(ActionBar.NAVIGATION_MODE_LIST);
            actionBar.setListNavigationCallbacks(mSpinnerAdapter, mOnNavigationListener);
            int dropdownIndex = Common.getPreachMeetingDropDownPref(getActivity());
    ...
    public void getDataFromBusiness(int dataType, Object t, int... position) {
        ...
        if (dataType == Common.PREACH_MEETING_TOTAL_TYPE) {
            ...
            universityPreachListScreenSlidePagerAdapter.setPageCount(pageManageUtil.pageCount);
            universityPreachListScreenSlidePagerAdapter.notifyDataSetChanged();
    ...
    public void queryTotal() {
        ...
        preachmeetingConciseReq.runningUniversity = ((UniversityCampusActivity) getActivity()).university;
        QueryUniversityPreaching queryUniversityPreaching = new QueryUniversityPreaching();
        queryUniversityPreaching.queryPreachingTotal(preachmeetingConciseReq, this);
        return;
    }
    ...
    public void queryPreachmeetingList(int pageNumber) {
        ...
        preachmeetingConciseReq.runningUniversity = ((UniversityCampusActivity) getActivity()).university;
        QueryUniversityPreaching queryUniversityPreaching = new QueryUniversityPreaching();
        queryUniversityPreaching.queryPreachingList(preachmeetingConciseReq, this);
        return;
    }
    ...
    public Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            if (dataType == Common.ADD_PAGE_INDEX_TYPE) {
                ...
                universityPreachListScreenSlidePagerAdapter.startUpdate(preachMeetingPager);
                ((UniversityPreachsScreenSlidePagerFragment) universityPreachListScreenSlidePagerAdapter.instantiateItem(preachMeetingPager, uipage)).updateListView(pager, lv_preachmeetingConciseRsps);
                universityPreachListScreenSlidePagerAdapter.finishUpdate(preachMeetingPager);
            }
        }
    };
    ...
    public void onResume() {
        ...
        if (searchTerm != null) {
            if (!resumeSearchTerm.searchConditionItemEqual(searchTerm)) {
                ...
                universityPreachListScreenSlidePagerAdapter.setPageCount(0);
                universityPreachListScreenSlidePagerAdapter.notifyDataSetChanged();
                pagerData.clear();
                queryTotal();

            } else if (((UniversityCampusActivity) getActivity()).resumeFromWhere == UniversityCampusActivity.FROM_SEARCHACTIVITY) {
                searchTerm = resumeSearchTerm;
        ...
        super.onResume();
        //MobclickAgent.onPageStart("UniversityPreachingMeetListFragment");
    }
    ...
    public void onPause() {
        super.onPause();
        //MobclickAgent.onPageEnd("UniversityPreachingMeetListFragment");
    }
}
