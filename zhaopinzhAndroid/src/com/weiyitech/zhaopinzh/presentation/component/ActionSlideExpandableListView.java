...
import com.weiyitech.zhaopinzh.util.slideexpandablelistview.SlideExpandableListView;
import com.weiyitech.zhaopinzh.util.slideexpandablelistview.WrapperListAdapterImpl;
            ...
            public View getView(final int position, View view, ViewGroup viewGroup) {
                ...
                if (buttonIds != null && listView != null) {
                    for (int id : buttonIds) {
                        ...
                        if (buttonView != null) {
                            View sub = buttonView.findViewById(id);
