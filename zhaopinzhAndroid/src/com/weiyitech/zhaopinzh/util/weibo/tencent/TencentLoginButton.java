package com.weiyitech.zhaopinzh.util.weibo.tencent;
 ...
 */
public class TencentLoginButton extends Button {
    private static final String TAG = "TencentLoginButton";

    /** 微博授权时，启动 SSO 界面的 Activity */
    private Context mContext;

    public TencentLoginButton(Context context) {
        this(context, null);
    }

    public TencentLoginButton(Context context, AttributeSet attrs) {
        this(context, attrs, /*R.style.com_sina_weibo_sdk_loginview_default_style*/0);
    }

    public TencentLoginButton(Context context, AttributeSet attrs, int defStyle) {
...
//            this.setBackgroundResource(R.drawable.com_sina_weibo_sdk_button_grey);
            ...
            this.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_com_tencent_weibo_sdk_logo, 0, 0, 0);
            ...
            this.setText(R.string.com_tencent_weibo_sdk_login_with_weibo_account);
        }
    }
}
