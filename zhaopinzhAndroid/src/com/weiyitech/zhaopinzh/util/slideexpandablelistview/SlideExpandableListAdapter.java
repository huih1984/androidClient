...
public class SlideExpandableListAdapter extends AbstractSlideExpandableListAdapter {
    ...
    public SlideExpandableListAdapter(ListAdapter wrapped) {
        this(wrapped, R.id.toggle_button_id, R.id.expandable);
    }
    ...
    @Override
    void expandViewExtraAction(View button, View target, int position, int action) {
        iExtraAction.itemExpandAction(button, target, position, action);
    }

    public void setiExtraAction(IExtraAction iExtraAction) {
        this.iExtraAction = iExtraAction;
    }

    public interface IExtraAction {
        void itemExpandAction(View button, View target, int position, int action);
    }
}
