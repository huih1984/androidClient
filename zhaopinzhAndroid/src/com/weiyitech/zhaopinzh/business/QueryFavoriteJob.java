 ...
 */
public class QueryFavoriteJob  extends CommonBusiness {
    ...
    void sendTotalDataToPresentaition(final Fragment fragment, JSONObject jsonObject) throws ZhaopinzhException {
        try {
            if (jsonObject != null) {
                ...
                ((FavoriteListFragment)fragment).getDataFromBusiness(Common.JOBTOTAL_TYPE, pager);
            } else {
    ...
    void sendRunEmployerDataToPresentation(final Fragment fragment, JSONObject jsonObject) throws ZhaopinzhException {
        try {
            if (jsonObject != null) {
                ...
                ((FavoriteListFragment) fragment).getDataFromBusiness(Common.RUNEMPLOYER_TYPE, runEmployerPager);
            } else {
    ...
    void sendJobConciseDataToPresentation(Fragment fragment, JSONObject jsonObject, int position) throws ZhaopinzhException {
        try {
            ...
            if (jsonArray != null) {
                ...
                ((FavoriteListFragment) fragment).getDataFromBusiness(Common.JOBCONSICE_TYPE, jobConciseRsps, position);
            } else {
    ...
    void sendEmployerDetailDataToPresentation(Fragment fragment, JSONObject jsonObject, int position) throws ZhaopinzhException {
        try {
            ...
            if (jsonObject != null) {
                ...
                ((FavoriteListFragment) fragment).getDataFromBusiness(Common.EMPLOYERDETAIL_TYPE, employerDetailRsp, position);
            } else {
    ...
    public void queryTotal(Object params, final Fragment fragment){
        if(!checkNetWork(fragment.getActivity())){
            ((FavoriteListFragment) fragment).getDataFromBusiness(Common.NET_WORK_DISCONNECTED, null);
            return;
        }
